    ...
    <head style="margin: 0; padding: 0;">
        ...
        <script type="text/javascript">
            color.resize = function () {
                $("#tab1x-dic").jqGrid('setGridWidth', $("#dialog-dic #north").width());
                $("#tab1x-dic").jqGrid('setGridHeight', $("#dialog-dic #north").height() - 20);
...
//                $("#tab2-dic").jqGrid('setGridHeight', $("#dialog-dic #south").height() - 20);
            ...
            $(document).ready(function () {
                ...
                color.init_table1x($("#tab1x-dic"))
                color.load_table1x($("#tab1x-dic"))
...
//                color.load_table2($("#tab2-dic"));
    ...
    <body>
        <div id="north" style="height: calc(40% - 8px); width: calc(100% - 4px);">
            <table id="tab1x-dic"  class="ui-jqgrid-btable"></table> 
        </div>
