...
import LineSegment from '../../lib-js/jsts-2.11.2/org/locationtech/jts/geom/LineString.js';
        ...
        try {
            ...
            for (let frame of this.frames) {
                if (frame.h !== null) {
                    ...
                    if (ANG === 0) {
                        arcB = UGeo.lineArch(segm.p0.x, segm.p1.x, segm.p0.y, frame.h, frame.id);  //созд. арки на горизонтали 
                    } else {
                    ...
                    listShell.pushl(...arcB.getCoordinates());
