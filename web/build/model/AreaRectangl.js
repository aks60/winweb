...
export class AreaRectangl extends AreaSimple {
    ...
    setLocation() {
        try {
            ...
            this.frames.forEach(frame => cooBox.push(jsts.geom.Coordinate.new(frame.x1, frame.y1, frame.id)));
            cooBox.push(jsts.geom.Coordinate.new(this.frames[0].x1, this.frames[0].y1, this.frames[0].id));
