...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="style/jquery-ui-1.13/redmond/jquery-ui.css">          
        <link rel="stylesheet" type="text/css" media="screen" href="style/jqgrid-4.6.3/ui.jqgrid.css">
        <link rel="stylesheet" type="text/css" media="screen" href="style/jstree-3.3.12/themes/default/style.min.css" />
        <link rel="stylesheet" type="text/css" media="screen" href="style/menu.css">
        <link rel="stylesheet" type="text/css" media="screen" href="style/html-ui.css">
