    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            var SYSTREE = {id: 1, name: 2, glas: 3, depth: 4, col1: 5, col2: 6, col3: 7, cgrp: 8, types: 12, parent_id: 13},
                    GROUP = {id: 1, grup: 2, name: 4, val: 5}, COLOR = {id: 1, name: 3, rgb: 5, groups_id: 12},
                    ARTIKL = {id: 1, code: 2, level1: 3, level2: 4, name: 5, size_falz: 9, size_centr: 11, height: 14, depth: 15, analog_id: 35},
                    ARTDET = {id: 1, color_fk: 14, artikl_id: 15}, FURNITURE = {id: 1, name: 2},
                    ...
                    SYSPROD = {id: 1, name: 2, script: 3, systree_id: 4}, PRJPROD = {id: 1, name: 3, script: 4, project_id: 5, systree_id: 6},
                    PRJKIT = {id: 1, numb: 2, width: 3, height: 4, color1_id: 5, color2_id: 6, color3_id: 7, flag: 10, artikl_id: 11, prjprod_id: 12},
                    SYSPAR1 = {id: 1, text: 2, params_id: 3, systree_id: 4, fixed: 5}, PARAMS = {id: 1, text: 2, params_id: 12},
