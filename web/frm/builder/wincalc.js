...
//        try {
            ...
            this.color1Rec = dbset.find2(obj.color1, dbset.colorList);
            this.color2Rec = dbset.find2(obj.color2, dbset.colorList);
            this.color3Rec = dbset.find2(obj.color3, dbset.colorList);
