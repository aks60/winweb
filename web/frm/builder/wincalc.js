...
//        try {
            ...
            this.color1Rec = dbset.find(obj.color1, dbset.colorList);
            this.color2Rec = dbset.find(obj.color2, dbset.colorList);
            this.color3Rec = dbset.find(obj.color3, dbset.colorList);
