            ...
            <script type="module">
                ...
                $("#outbody").load('frm/login.jsp', function () {
                    ...
                    $.when(
                        ...
                        dbset.artiklList.virtualRec = createVirtueRec(37, {1: -3, 2: 'Автокальк', 5: 'Автокальк', 14: 80, 15: 4, 35: -3});
                        dbset.artdetList.virtualRec = createVirtueRec(37, {1: -3, 14: -3, 15: -3});
                        dbset.colorList.virtualRec = createVirtueRec(15, {1: -3, 2: 'Автокальк', 4: -3, 14: -3});
