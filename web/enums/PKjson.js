export const PKjson = {
    ...
    ioknaParam: "ioknaParam", //Параметры iokna
    ...
    stvorkaTop: "stvorkaTop", //Элемент    
    stvorkaLef: "stvorkaLef", //Элемент 
 
    horRasc: "horRasc", //количество проёмов раскладки
    verRasc: "verRasc"  //количество проёмов раскладки
};
PKjson.stvorkaSide = [PKjson.stvorkaLef, PKjson.stvorkaBot, PKjson.stvorkaRig, PKjson.stvorkaTop];
