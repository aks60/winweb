...
//        response.setHeader("Expires", "0");
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                ...
                } else if (action.equalsIgnoreCase("furnside1List")) {
                    out.write(Dbset.furnside1List(request, response));

                } else if (action.equalsIgnoreCase("furndetList")) {
                    out.write(Dbset.furndetList(request, response));

                } else if (action.equalsIgnoreCase("furnpar2List")) {
                    out.write(Dbset.furnpar2List(request, response));
                ...
                } else if (action.equalsIgnoreCase("updatePrjpart")) {
                    JSONObject output = Dbset.updatePrjpart(request, response);
                    out.write(JSONObject.toJSONString(output));
                ...
                } else if (action.equalsIgnoreCase("updatePrjprod")) {
                    JSONObject output = Dbset.updatePrjprod(request, response);
                    out.write(JSONObject.toJSONString(output));

                } else if (action.equalsIgnoreCase("insertKit")) {
                ...
                } else if (action.equalsIgnoreCase("deletePrjpart")) {
                    JSONObject output = Dbset.deletePrjpart(request, response);
                    out.write(JSONObject.toJSONString(output));
